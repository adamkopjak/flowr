  ...
  return (
    <div className="app-wrap">
      ...
      <header style={{
        ...
        <div style={{display:'flex', alignItems:'center', gap:10}}>
          <div className="chip" style={{padding:'6px 12px'}}>
            ...
            <span className="data-chip-text">{source==='live' ? 'Live data' : source==='fallback' ? 'Demo data' : 'Connecting…'}</span>
          </div>
      ...
      <section className="card" style={{padding: 8}}>
        {/* table header */}
        <div className="price-grid price-grid-head" style={{
          fontSize: 11, color:'var(--text-faint)',
          textTransform:'uppercase', letterSpacing:'0.08em',
          borderBottom:'1px solid var(--border)'
        }}>
          <span className="col-watch"></span>
          <span className="col-rank">#</span>
          <span className="col-asset">Asset</span>
          <span className="col-price" style={{textAlign:'right'}}>Price</span>
          <span className="col-change" style={{textAlign:'right'}}>24h</span>
          <span className="col-mcap" style={{textAlign:'right'}}>Market cap</span>
          <span className="col-spark" style={{textAlign:'right'}}>7d chart</span>
          <span className="col-trade"></span>
        </div>
